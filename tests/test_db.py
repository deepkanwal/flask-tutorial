...
# connection each time it’s called. After the context, the
...
# output a message. This test uses Pytest’s monkeypatch fixture
# to replace the init_db function with one that records that
